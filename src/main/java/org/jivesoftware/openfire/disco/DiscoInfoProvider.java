...
public interface DiscoInfoProvider {
     ...
     */
    Iterator<Element> getIdentities( String name, String node, JID senderJID, String domain );
     ...
     */
    Iterator<String> getFeatures( String name, String node, JID senderJID, String domain );
     ...
     */
    @Deprecated
    DataForm getExtendedInfo( String name, String node, JID senderJID, String domain );
     ...
     */
    default Set<DataForm> getExtendedInfos( String name, String node, JID senderJID, String domain ) {
        final Set<DataForm> forms = new HashSet<DataForm>();
        if(getExtendedInfo( name, node, senderJID, domain )!= null){
             forms.add(getExtendedInfo( name, node, senderJID, domain ));
            return forms;
        }else{
            return forms;
        }   
     ...
     */
    boolean hasInfo( String name, String node, JID senderJID , String domain);
}
