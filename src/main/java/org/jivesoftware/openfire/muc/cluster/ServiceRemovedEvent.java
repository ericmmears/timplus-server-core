...
public class ServiceRemovedEvent implements ClusterTask<Void> {
    ...
    public ServiceRemovedEvent(String subdomain, String domain) {
    ...
    @Override
    public void run() {
        XMPPServer.getInstance().getMultiUserChatManager().unregisterMultiUserChatService(subdomain, domain, false);
    }
