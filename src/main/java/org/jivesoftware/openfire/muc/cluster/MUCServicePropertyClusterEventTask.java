...
public class MUCServicePropertyClusterEventTask implements ClusterTask<Void> {
    ...
    public static MUCServicePropertyClusterEventTask createPutTask(String service, String domain, String key, String value) {
    ...
    public static MUCServicePropertyClusterEventTask createDeleteTask(String service, String domain, String key) {
        MUCServicePropertyClusterEventTask task = new MUCServicePropertyClusterEventTask();
    ...
    public void run() {
        if (Type.put == event) {
            MUCPersistenceManager.setLocalProperty(service, domain, key, value);
        }
        else if (Type.deleted == event) {
            MUCPersistenceManager.deleteLocalProperty(service, domain, key);
        }
    }
