...
public class IQMUCSearchHandler
{
    ...
    private static boolean canBeIncludedInResult(MUCRoom room)
    {
        ...
        final boolean discoverLocked = MUCPersistenceManager.getBooleanProperty(room.getMUCService().getServiceName(), room.getMUCService().getDomain(), "discover.locked", true);
