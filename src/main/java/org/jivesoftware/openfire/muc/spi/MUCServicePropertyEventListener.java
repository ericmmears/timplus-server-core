...
public interface MUCServicePropertyEventListener {
     ...
     * @param domain the domain of the service the property was set on.
     * @param property the name of the property.
     * @param params event parameters.
     */
    void propertySet( String service, String domain, String property, Map<String, Object> params );
     ...
     * @param params event parameters.
     */
    void propertyDeleted( String service, String domain, String property, Map<String, Object> params );
