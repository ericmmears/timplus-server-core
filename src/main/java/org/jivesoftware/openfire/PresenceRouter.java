...
public class PresenceRouter extends BasicModule {
        ...
        try {
            ...
            if (type == null || Presence.Type.unavailable == type) {
                ...
                if (recipientJID == null || recipientJID.getDomain() == null ||
                    ...
                    if (senderJID != null && !DomainManager.getInstance().isRegisteredDomain(senderJID.getDomain()) &&
    ...
    private void bounce(Presence presence) {
        ...
        if (presence.getFrom() == null || DomainManager.getInstance().isRegisteredDomain(presence.getFrom().toString())) {
