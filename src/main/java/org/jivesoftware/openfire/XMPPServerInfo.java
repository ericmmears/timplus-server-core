...
public interface XMPPServerInfo {
    ...
    /**
     * Obtain all domains managed by the server
     *
     * @param enabledOnly Indicates if only enabled domains should be retrieved
     * @return all XMPP domains this server is part of
     */
    Collection<Domain> getXMPPDomains(boolean enabledOnly);
