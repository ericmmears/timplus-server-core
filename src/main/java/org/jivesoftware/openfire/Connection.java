...
public interface Connection extends Closeable {
    ...
    /**
     * Gets the domain name associated with the connection.  The domain is established at the time the initial stream header is sent
     * as is eventually associated with a session.
     * @return The domain associate with the connection.
     */
    String getConnectionDomain();
    
    /**
     * Sets the domain name associate with the connection.
     * @param domain The domain name to associate with the connection;
     */
    void setConnectionDomain(String domain);
