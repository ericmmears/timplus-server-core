...
public class DefaultUserProvider implements UserProvider {
    ...
    private static final String LOAD_USER =
            "SELECT salt, serverKey, storedKey, iterations, name, email, creationDate, modificationDate, domain FROM ofUser WHERE username=?";
    private static final String USER_COUNT =
            "SELECT count(*) FROM ofUser";
    private static final String ALL_USERS =
            "SELECT username FROM ofUser ORDER BY username";
    private static final String ALL_USERS_BY_DOMAIN =
            "SELECT username FROM ofUser where domain=? ORDER BY username";    
    private static final String INSERT_USER =
            "INSERT INTO ofUser (username,name,email,creationDate,modificationDate,domain) " +
            "VALUES (?,?,?,?,?,?)";
    ...
    public User loadUser(String username) throws UserNotFoundException
    {
        ...
        try {
            ...
            User user = new User(username, name, email, domainName, creationDate, modificationDate);
            user.setSalt(salt);
    ...
    @Override
    public User createUser(String username, String password, String domain, String name, String email)
            throws UserAlreadyExistsException
    {
        try {
            ...
            return new User(username, name, email, domain, now, now);
        }
    }
    ...
    public Collection<User> getUsersByDomain(String domainName) 
    {
        ...
        {
            con = DbConnectionManager.getConnection();
            pstmt = con.prepareStatement(ALL_USERS_BY_DOMAIN);
