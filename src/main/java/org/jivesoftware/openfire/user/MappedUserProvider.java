...
public class MappedUserProvider extends UserMultiProvider
{
    ...
    @Override
    public User createUser( String username, String password, String domain, String name, String email ) throws UserAlreadyExistsException
    {
        return getUserProvider( username ).createUser( username, password, domain, name, email );
    }
