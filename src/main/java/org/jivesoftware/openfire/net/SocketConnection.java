...
public class SocketConnection implements Connection {
    ...
    public void startTLS(boolean clientMode, boolean directTLS) throws IOException {
        if (!secure) {
            ...
            try
            {
            	ReferenceIDUtil.setSessionReferenceId(tlsStreamHandler.getSSLSession(), this.getConnectionDomain());
            ...
            {
            	ReferenceIDUtil.removeSessionReferenceId(tlsStreamHandler.getSSLSession());
            }
	...
	@Override
	public void setConnectionDomain(String domain)
	{
		this.domain = domain;
	}
