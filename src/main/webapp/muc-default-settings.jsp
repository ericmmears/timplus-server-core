...
<%  // Get parameters
    ...
    if (save) {
        try {
            ...
            MUCPersistenceManager.setProperty(mucname, mucdomain, "room.maxUsers", maxUsers);
        }
        catch (Exception e) {
        ...
        if (errors.size() == 0) {
            if (publicRoom != null && publicRoom.trim().length() > 0) {
                MUCPersistenceManager.setProperty(mucname, mucdomain, "room.publicRoom", "true");
            }
            else {
                MUCPersistenceManager.setProperty(mucname, mucdomain, "room.publicRoom", "false");
            }
            if (persistentRoom != null && persistentRoom.trim().length() > 0) {
                MUCPersistenceManager.setProperty(mucname, mucdomain, "room.persistent", "true");
            }
            else {
                MUCPersistenceManager.setProperty(mucname, mucdomain, "room.persistent", "false");
            }
            if (moderatedRoom != null && moderatedRoom.trim().length() > 0) {
                MUCPersistenceManager.setProperty(mucname, mucdomain, "room.moderated", "true");
            }
            else {
                MUCPersistenceManager.setProperty(mucname, mucdomain, "room.moderated", "false");
            }
            if (membersOnly != null && membersOnly.trim().length() > 0) {
                MUCPersistenceManager.setProperty(mucname, mucdomain, "room.membersOnly", "true");
            }
            else {
                MUCPersistenceManager.setProperty(mucname, mucdomain, "room.membersOnly", "false");
            }
            if (nonanonymous != null && nonanonymous.trim().length() > 0) {
                MUCPersistenceManager.setProperty(mucname, mucdomain, "room.canAnyoneDiscoverJID", "true");
            }
            else {
                MUCPersistenceManager.setProperty(mucname, mucdomain, "room.canAnyoneDiscoverJID", "false");
            }
            if (allowInvites != null && allowInvites.trim().length() > 0) {
                MUCPersistenceManager.setProperty(mucname, mucdomain, "room.canOccupantsInvite", "true");
            }
            else {
                MUCPersistenceManager.setProperty(mucname, mucdomain, "room.canOccupantsInvite", "false");
            }
            if (changeSubject != null && changeSubject.trim().length() > 0) {
                MUCPersistenceManager.setProperty(mucname, mucdomain, "room.canOccupantsChangeSubject", "true");
            }
            else {
                MUCPersistenceManager.setProperty(mucname, mucdomain, "room.canOccupantsChangeSubject", "false");
            }
            if (reservedNick != null && reservedNick.trim().length() > 0) {
                MUCPersistenceManager.setProperty(mucname, mucdomain, "room.loginRestrictedToNickname", "true");
            }
            else {
                MUCPersistenceManager.setProperty(mucname, mucdomain, "room.loginRestrictedToNickname", "false");
            }
            if (canChangeNick != null && canChangeNick.trim().length() > 0) {
                MUCPersistenceManager.setProperty(mucname, mucdomain, "room.canChangeNickname", "true");
            }
            else {
                MUCPersistenceManager.setProperty(mucname, mucdomain, "room.canChangeNickname", "false");
            }
            if (registrationEnabled != null && registrationEnabled.trim().length() > 0) {
                MUCPersistenceManager.setProperty(mucname, mucdomain, "room.registrationEnabled", "true");
            }
            else {
                MUCPersistenceManager.setProperty(mucname, mucdomain, "room.registrationEnabled", "false");
            }
            if (enableLog != null && enableLog.trim().length() > 0) {
                MUCPersistenceManager.setProperty(mucname, mucdomain, "room.logEnabled", "true");
            }
            else {
                MUCPersistenceManager.setProperty(mucname, mucdomain, "room.logEnabled", "false");
            }
        }
        ...
        <tbody>
            <tr>
                <td width="1%">
                    ...
                    <%= ((MUCPersistenceManager.getBooleanProperty(mucname, mucdomain, "room.publicRoom", true)) ? "checked" : "") %>>
                </td>
                <td width="99%">
            ...
            <tr>
                <td width="1%">
                    ...
                    <%= ((MUCPersistenceManager.getBooleanProperty(mucname, mucdomain, "room.persistent", false)) ? "checked" : "") %>>
                </td>
                <td width="99%">
            ...
            <tr>
                <td width="1%">
                    ...
                    <%= ((MUCPersistenceManager.getBooleanProperty(mucname, mucdomain, "room.moderated", false)) ? "checked" : "") %>>
                </td>
                <td width="99%">
            ...
            <tr>
                <td width="1%">
                    ...
                    <%= ((MUCPersistenceManager.getBooleanProperty(mucname, mucdomain, "room.membersOnly", false)) ? "checked" : "") %>>
                </td>
                <td width="99%">
            ...
            <tr>
                <td width="1%">
                    ...
                    <%= ((MUCPersistenceManager.getBooleanProperty(mucname, mucdomain, "room.canAnyoneDiscoverJID", true)) ? "checked" : "") %>>
                </td>
                <td width="99%">
            ...
            <tr>
                <td width="1%">
                    ...
                    <%= ((MUCPersistenceManager.getBooleanProperty(mucname, mucdomain, "room.canOccupantsInvite", false)) ? "checked" : "") %>>
                </td>
                <td width="99%">
            ...
            <tr>
                <td width="1%">
                    ...
                    <%= ((MUCPersistenceManager.getBooleanProperty(mucname, mucdomain, "room.canOccupantsChangeSubject", false)) ? "checked" : "") %>>
                </td>
                <td width="99%">
            ...
            <tr>
                <td width="1%">
                    ...
                    <%= ((MUCPersistenceManager.getBooleanProperty(mucname, mucdomain, "room.loginRestrictedToNickname", false)) ? "checked" : "") %>>
                </td>
                <td width="99%">
            ...
            <tr>
                <td width="1%">
                    ...
                    <%= ((MUCPersistenceManager.getBooleanProperty(mucname, mucdomain, "room.canChangeNickname", true)) ? "checked" : "") %>>
                </td>
                <td width="99%">
            ...
            <tr>
                <td width="1%">
                    ...
                    <%= ((MUCPersistenceManager.getBooleanProperty(mucname, mucdomain, "room.registrationEnabled", true)) ? "checked" : "") %>>
                </td>
                <td width="99%">
            ...
            <tr>
                <td width="1%">
                    ...
                    <%= ((MUCPersistenceManager.getBooleanProperty(mucname, mucdomain, "room.logEnabled", true)) ? "checked" : "") %>>
                </td>
                <td width="99%">
                ...
                <td width="99%">
                    ...
                    <select name="roomconfig_maxusers">
                        <% for(int i=10; i<=50; i=i+10) { %>
                            <option value="<%= i %>"
                            <%= ((MUCPersistenceManager.getIntProperty(mucname, mucdomain, "room.maxUsers", 30)) == i ? "selected=\"selected\"" : "") %>
                            ><%= i %></option>
                        <% } %>
                        <option value="<%= 0 %>"
                        <%= ((MUCPersistenceManager.getIntProperty(mucname, mucdomain, "room.maxUsers", 30)) == 0 ? "selected=\"selected\"" : "") %>
