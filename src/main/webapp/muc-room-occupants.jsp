...
<%  // Get parameters
    ...
    if (kick != null) {
        ...
        if (role != null) {
            try {
                room.kickOccupant(role.getUserAddress(), XMPPServer.getInstance().createJID(webManager.getUser().getUsername(), webManager.getUser().getDomain(), null), null, consoleKickReason);
                // Log the event
