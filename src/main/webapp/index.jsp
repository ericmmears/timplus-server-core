...
<% // Get parameters //
    ...
    LoggerFactory.getLogger("index.jsp").info("Executing web request");

    ConnectionManagerImpl connectionManager = ((ConnectionManagerImpl) XMPPServer.getInstance().getConnectionManager());

    LoggerFactory.getLogger("index.jsp").info("Getting the admin plugin");
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="c2">
                    ...
                    <% } %>
                    <c:out value="${webManager.getXMPPDomainsAsString()}"/>
                </td>
            </tr>
            <tr><td>&nbsp;</td></tr>
        </tbody>
...
%>
    ...
    <% } %>
    <%
        if (mediaProxyService != null && mediaProxyService.isEnabled()) {
    %>
    <tr>
        <td><%= interfaceName %></td>
