...
<%  // Get parameters //
    ...
    MultiUserChatService muc = webManager.getMultiUserChatManager().getMultiUserChatService(mucname, mucdomain);
    ...
    if (delete) {
        ...
        if (muc != null) {
            ...
            webManager.getMultiUserChatManager().removeMultiUserChatService(mucname, mucdomain);
        }
        // Done, so redirect
