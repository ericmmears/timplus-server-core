...
<thead>
    <tr>
        ...
        <th nowrap><fmt:message key="user.create.domain" /></th>        
...
<%
    ...
    for (User user : users) {
        ...
        Boolean isAdmin = AdminManager.getInstance().isUserAdmin(user.getUsername(), user.getDomain(), false);
%>
    <tr class="jive-<%= (((i%2)==0) ? "even" : "odd") %>">
        ...
        <td width="18%">
            <%= StringUtils.escapeHTMLTags(user.getDomain()) %> &nbsp;
        </td>        
        <td width="18%">
